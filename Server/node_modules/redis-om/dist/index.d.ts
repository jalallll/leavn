...
export { Client, SearchDataStructure, RedisHashData, RedisJsonData, Entity, EntityData, EntityValue, EntityConstructor, RedisError, Repository, Schema, SchemaDefinition, Point, FieldDefinition, SchemaOptions, DataStructure, IdStrategy, StopWordOptions, BaseFieldDefinition, SortableFieldDefinition, SeparableFieldDefinition, BooleanFieldDefinition, DateFieldDefinition, NumberFieldDefinition, PointFieldDefinition, StringFieldDefinition, StringArrayFieldDefinition, TextFieldDefinition, SchemaFieldType, AbstractSearch, Search, RawSearch, SubSearchFunction, Where, WhereField, Circle, CircleFunction };
